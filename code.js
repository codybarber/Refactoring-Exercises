...
function beats(aPlayer, anotherPlayer) {
  if (aPlayer === 'rock' && anotherPlayer === 'scissors' || aPlayer === 'scissors' && anotherPlayer === 'paper' || aPlayer === 'paper' && anotherPlayer === 'rock') {
    return true;
  } else {
    return false;
  }
...
//   if (beats(player1, player2) === true && beats(player2, player1) === false) {
//     return 'player 1';
//   } else if (beats(player2, player1) === true && beats(player1, player2) === false) {
//     return 'player 2';
//   } else if (beats(player1, player2) === false && beats(player2, player1) === false) {
//     return 'draw';
//   }
// }
